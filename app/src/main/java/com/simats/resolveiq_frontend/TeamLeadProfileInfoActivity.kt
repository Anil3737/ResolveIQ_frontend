...
import com.simats.resolveiq_frontend.databinding.ActivityTeamLeadProfileInfoBinding
...
class TeamLeadProfileInfoActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTeamLeadProfileInfoBinding
    private lateinit var userPreferences: UserPreferences
    private lateinit var authRepository: AuthRepository

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTeamLeadProfileInfoBinding.inflate(layoutInflater)
    ...
    private fun loadProfileData() {
        ...
        if (intentFullName != null) {
            // Viewing another user's profile (from Admin)
            ...
            val intentLeadFor = intent.getStringExtra("department") ?: "-"
            
            updateUI(intentFullName, intentRole, intentEmpId, intentEmail, intentLocation, intentLeadFor)
            return
        }
            ...
            if (result.isSuccess) {
                ...
                user?.let {
                    ...
                    updateUI(
                        ...
                        it.department_name ?: "Hardware & Systems"
                    )
